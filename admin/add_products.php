    ...
    if (isset($_POST["submit-upload"])){
      ...
      if ($errorcount === 0){
          ...
          if(in_array($fileType, $allowTypes)){
              ...
              $check = mysqli_query($conn, "SELECT * FROM `products` WHERE id = '$p_id'") or die('query failed');
              if(mysqli_num_rows($check) > 0){
                  
                  $msg_iv = "Product ID already Exsits"; 
              }else{
                   // Upload file to server
                  if(move_uploaded_file($_FILES["p-img"]["tmp_name"], $targetFilePath)){
                      //update user in database
                      $query = "INSERT INTO `products` (id, price, description, stock, status, name, img) VALUES('$p_id', '$p_price', '$p_des', '$p_stock', '$p_status', '$p_name', '$p_img')";
              ...
              $msg_iv = 'Sorry, only JPG, JPEG, PNG, & GIF files are allowed to upload.';
          }                 
      }
  }
?>
...
.container-tbll .shopping-cart-tbl{
   padding:20px 0;
}
...
.container-tbl .shopping-cart-tbl table thead{
   background-color: var(--black);
}

.container-tbl .shopping-cart-tbl table thead th{
   padding:10px;
   color:var(--white);
   text-transform: capitalize;
   font-size: 16px;
...
.container-tbl .shopping-cart-tbl table tr td{
   padding:10px;
   font-size: 16px;
   color:var(--black);
}

.container-tbl .shopping-cart-tbl .cart-btn{
   margin-top: 10px;
   text-align: center;
}
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                              <section class="form-fields">
                                    ...
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-id" type="text" value="">
                                          </div>
                                    ...
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-name" type="text" value="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-des" type="text" value="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-price" type="text" value="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-stock" min="1" type="number" value="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-status" type="text" value="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="p-img" type="file">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                              </section>
        ...
        <section id="main">
            ...
            <section id="content" class="page-content">
                  ...
                  <div class="container-tbl">
                    <div class="shopping-cart-tbl">
                      <h1 class="heading-tbl">View Products, Edit and Delete</h1>
                      <table>
                          <thead>
                              <th>image</th>
                              <th>name</th>
                          ...
                          <tbody>
                            ...
                            ?>
                            <tr>
                                <td><img src="../images/<?php echo $fetch_product['img']; ?>" height="100" width = "30%" alt="<?php echo $fetch_product; ?>"></td>
                                <td><?php echo $fetch_product['name']; ?></td>
                                <td>R<?php echo $fetch_product['price']; ?></td>
                                <td><?php echo $fetch_product['description']; ?></td>
                                <td><?php echo $fetch_product['stock']; ?></td>
                                <td><?php echo $fetch_product['status']; ?></td>
                                <td><a href="update_products.php?<?php echo 'id='. $fetch_product['id'] ?>" class="mr-3" title="Update Record"><span class="fa fa-pencil"></span></td>
                                <td><a href="delete_products.php?<?php echo 'id='. $fetch_product['id'] ?>" title="Delete Record"><span class="fa fa-trash"></span></td>
                            </tr>
                            <?php
                                  }
                              }else{
