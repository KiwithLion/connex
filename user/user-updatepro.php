<?php
    ...
    if (isset($_POST["submit-update"])){
      ...
      if (empty($fname) || empty($sname) || empty($email) || empty($number) || empty($pwd)){
          $msgiv = "<style=color:#dd0909;>Fill in all fields!</style>";
          $errorcount++;

      }
      
      // Validate name
      if(!filter_var($fname, FILTER_VALIDATE_REGEXP, array("options"=>array("regexp"=>"/^[a-zA-Z\s]+$/")))){
      ...
      if ($errorcount === 0){
            ...
            $query = "UPDATE `user_login` SET `user_Fname`='$f_name',`user_Email`='$email',`user_Phone`='$number',`user_Pwd`='$newPwd' WHERE user_Fname = '$user'";
  ...
  <div id="_desktop_user_info">
    <div class="user-info">
      ...
      <div class="hidden-sm-down">
          <span class="welcome">Welcome,</span>
                      <a class="account" href="https://connexstore.co.za/my-account" title="View my customer account" rel="nofollow"><?php echo $user;?></a>
    ...
    <section id="main">
      ...
      <section id="content" class="page-content">
            ...
            <?php
                  $select_user = mysqli_query($conn, "SELECT * FROM `user_login` WHERE user_Fname = '$user'") or die('query failed');
                  if(mysqli_num_rows($select_user) > 0){
                        while($fetch_product = mysqli_fetch_assoc($select_user)){
                              $fname = $fetch_product['user_Fname'];
                              $email = $fetch_product['user_Email'];
                              $phone = $fetch_product['user_Phone'];
                              $pass = $fetch_product['user_Pwd'];
                        }
                  };
            ?>
            <div class="address-form">
                  <div class="js-address-form">
                        <?php
                              ...
                              $name_parts = preg_split("/[\s,]+/", $fname);
                              $f_name = $name_parts[0];
                              $s_name = array_slice($name_parts, -1)[0];
                        ...
                        <form method="POST" action="">
                              <section class="form-fields">
                                    ...
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="firstname" type="text" value="<?php echo $f_name;?>" maxlength="255" required="">
                                          </div>
                                    ...
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="lastname" type="text" value="<?php echo $s_name;?>" maxlength="255" required="">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                    ...
                                    <div class="form-group row ">
                                          <label class="col-md-3 form-control-label">Cell Phone</label>
                                          <div class="col-md-6">
                                                <input class="form-control" name="phone" type="number" value="<?php echo "0$phone";?>">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                                    <div class="form-group row ">
                                          ...
                                          <div class="col-md-6">
                                                <input class="form-control" name="pwd" type="password" value="<?php echo $pass;?>">
                                          </div>
                                          <div class="col-md-3 form-control-comment"></div>
                                    </div>
                              </section>
                              <footer class="form-footer text-sm-center clearfix">          
                                    <button id="submit-login" name="submit-update" class="btn btn-primary" data-link-action="sign-in" type="submit">
                                          Update
                                    </button>
                              </footer>
                        </form>
      ...
      <footer class="page-footer">
            <a href="shop.php" class="account-link">
