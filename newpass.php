<?php
    ...
    if(isset($_POST['submit-getpass'])){
        ...
        if (empty($code) || empty($pwd) || empty($cpwd))
        {
            $msgiv = "Fields cannot be empty!<br>";
        }
        ...
        if($pwd !== $cpwd){
            ...
            $select_user = mysqli_query($conn, "SELECT * FROM `getnewpass` WHERE user_Newpass = '$code'") or die('query failed');
            if(mysqli_num_rows($select_user) > 0){
                while($fetch_product = mysqli_fetch_assoc($select_user)){
                    $email = $fetch_product['user_Email'];
                }
                ...
                if(mysqli_num_rows($check) > 0){
                    while($fetch_product = mysqli_fetch_assoc($check)){
                        $emailcheck = $fetch_product['user_Email'];
                    }

                        //update password in database
                        $query = "UPDATE `user_login` SET `user_Pwd`='$newPwd' WHERE user_Email = '$email'";
                    
                        $result = mysqli_query($conn, $query);
                        if ($result)
                        {
                            $msgv = "Password updated successfully!";
                        ...
                        $msgiv = "$email doesn't exist!";
                    }
            
            }else{
                
                    $msgiv = "$code doesn't exist!";
            }
        }
...
<html lang="en" class="">
      <head>
        ...
        <link rel="stylesheet" rel="preload" as="style" href="https://fonts.googleapis.com/css?family=Poppins:400,600&amp;subset=latin,latin-ext&display=block" type="text/css" media="all" />
            ...
            <script src="https://www.google.com/recaptcha/api.js?onload=rcf_onloadCallback&amp;render=explicit&amp;hl=en" async="" defer=""></script>
                            ...
                            <form id="login-form" action="" method="post">
                                    <section>
                                        <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" name="code" type="textl" value="">
                                                </div>
                                        ...
                                        <div class="form-group row ">
                                                ...
                                                <div class="col-md-6">
                                                    <input class="form-control" name="cpwd" type="password" value="">
                                                </div>
                                                <div class="col-md-3 form-control-comment"></div>
                                        </div>
                                    </section>
                                    <footer class="form-footer text-sm-center clearfix">          
                                        <button id="submit-login" name="submit-getpass" class="btn btn-primary" data-link-action="sign-in" type="submit">
                                        Get New Password
                                        </button>
                                    </footer>
                                    <section>
  ...
  <!--
      <div class="block oneall_social_login_block" id="oneall_social_login_block_customer_login_form">
              ...
              </p><div class="oneall_social_login_providers" id="oneall_social_login_providers_3593219" data-processed="true" style="min-height: 81px;"><iframe id="oa_social_login_frame_14374" frameborder="0" scrolling="no" allowtransparency="true" data-processed="true" title="Login with Social Networks" name="OneAll Social Login" src="https://connexstorecoza.api.oneall.com/socialize/login/frame/?oakk=14374&amp;oakv=&amp;lang=en" style="border: 0px none; width: 1487px; height: 81px; background-color: transparent;"></iframe></div>
              <script type="text/javascript">
                var _oneall = _oneall || [];
                ...
                _oneall.push(['social_login', 'do_render_ui', 'oneall_social_login_providers_3593219']);			
              </script>
          <p></p>
      </div>-->
