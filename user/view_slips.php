  ...
  <div id="_desktop_user_info">
    ...
    <section id="main">
      ...
      <section id="content" class="page-content">
            ...
            <?php
                  $select_user = mysqli_query($conn, "SELECT * FROM `purchase_order` WHERE user_Name = '$user'") or die('query failed');
                  if(mysqli_num_rows($select_user) > 0){
                        while($fetch_product = mysqli_fetch_assoc($select_user)){
                              $fname = $fetch_product['user_Name'];
                              $total = $fetch_product['pur_Totamount'];
                              $address = $fetch_product['pur_Address'];
                              $slip = $fetch_product['pur_Slip'];
                              $order_Ref = $fetch_product['pur_orderID'];
            ?>
                  ...
                  <div class="js-address-form">
                        <form method="POST" action="">
                            <section class="form-fields">
                                ...
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Customer Full name:&nbsp;&nbsp;<?php echo $fname;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Order Number:&nbsp;&nbsp;<?php echo $order_Ref;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Total Amount:&nbsp;&nbsp;<?php echo "R".$total;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label">Delivery Address:&nbsp;&nbsp;<?php echo $address;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label">Slip:&nbsp;&nbsp;<?php echo "<br>$slip";?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                            </section>
                        </form>
                        <?php 
                            ...
                            else
                            {
                                echo "
                                    <div class='form-group row '>
                                            <label class='col-md-3 form-control-label'>No purchase history that has been record(ed).</label>
                                    </div>
                                ";
                            }
      ...
      <footer class="page-footer">
            <a href="user-updatepro.php" class="account-link">
                  <i class="material-icons"></i>
                  <span>Back to update account</span>
            </a>
