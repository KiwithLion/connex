  ...
  <div id="_desktop_user_info">
    ...
    <section id="main">
      ...
      <section id="content" class="page-content">
            ...
            <?php
                  $select_user = mysqli_query($conn, "SELECT * FROM `user_login`") or die('query failed');
                  ...
                  <div class="js-address-form">
                        ...
                        <form method="POST" action="">
                            <section class="form-fields">
                                ...
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">First Name:&nbsp;&nbsp;<?php echo $f_name;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Surname:&nbsp;&nbsp;<?php echo $s_name;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label">Email:&nbsp;&nbsp;<?php echo $email;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label">Cell Number:&nbsp;&nbsp;<?php echo "0$phone";?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                            </section>
                        ...
                        <?php 
                            ...
                            else
                            {
                                echo "
                                    <div class='form-group row '>
                                            <label class='col-md-3 form-control-label'>No user(s) that are registered.</label>
                                    </div>
                                ";
                            }
                            ...
                            if (isset($_POST["submit-delete"])){
                                ...
                                $query = "DELETE FROM `user_login` WHERE user_Fname = '$fname'";
                        
                                $result = mysqli_query($conn, $query);
                                if ($result)
                                {
                                  $msg_v = "Admin you successfully deleted a User!";
                                }
                                else
                                {
