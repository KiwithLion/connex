  ...
  <div id="_desktop_user_info">
    ...
    <section id="main">
      ...
      <section id="content" class="page-content">
            ...
            <?php
                  $select_user = mysqli_query($conn, "SELECT * FROM `purchase_order`") or die('query failed');
                  ...
                  <div class="js-address-form">
                        <form method="POST" action="">
                            ...
                            <footer class="form-footer text-sm-center clearfix">          
                                <button id="submit-login" name="submit-delete" class="btn btn-primary" data-link-action="sign-in" type="submit">
                                        Delete
                                </button>
                            </footer>
                        </form>
                        <?php 
                            ...
                            if (isset($_POST["submit-delete"])){
                                ...
                                $query = "DELETE FROM `pur_order` WHERE user_Fname = '$fname'";
                        
                                $result = mysqli_query($conn, $query);
                                if ($result)
                                {
                                    $msg_v = "Admin you successfully deleted a User purchase!";
                                }
                                else
                                {
