  ...
  <div id="_desktop_user_info">
    ...
    <section id="main">
          ...
          <header class="page-header">
            <h1>
        View Customer Request Password Code
    </h1>
          </header>
      ...
      <section id="content" class="page-content">
            ...
            <?php
                  $select_user = mysqli_query($conn, "SELECT * FROM `getnewpass`") or die('query failed');
                  if(mysqli_num_rows($select_user) > 0){
                        while($fetch_product = mysqli_fetch_assoc($select_user)){
                              $U_email = $fetch_product['user_Email'];
                              $codePass = $fetch_product['user_Newpass'];
            ?>
                  ...
                  <div class="js-address-form">
                        <form method="POST" action="">
                            <section class="form-fields">
                                ...
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Customer Email:&nbsp;&nbsp;<?php echo $U_email;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                                <div class="form-group row ">
                                        <label class="col-md-3 form-control-label required">Code For New Password:&nbsp;&nbsp;<?php echo $codePass;?></label>
                                        <div class="col-md-3 form-control-comment"></div>
                                </div>
                            </section>
                        ...
                        <?php 
                            ...
                            else
                            {
                                echo "
                                    <div class='form-group row '>
                                            <label class='col-md-3 form-control-label'>No New Password(s) history that has been record(ed).</label>
                                    </div>
                                ";
                            }
