<?php
      ...
      if (isset($_POST['submit-pay'])){
            ...
            $creditnumber = $_POST['credit-num'];
            $expiredate = $_POST['month'];
            $expirenum = $_POST['cv-num'];
            ...
            $message = "<br> =============================== <br> Congradulations, your purchase was successful, do come back and enjoy the product! <br> ===========================<br>";
    
            $errornum = 0;
            $countstr = strlen($creditnumber);
            $digitstr = strlen($expirenum);
    
            if ($countstr < 16){
                $errornum++;
                $msgiv = "Error Incorrect card number!";
            }
    
            if ($digitstr < 3){
                $errornum++;
                $msgiv = "Error Incorrect expire number!";
            }
    
            if ($errornum === 0){
    
                  $check = mysqli_query($conn, "SELECT * FROM `user_login` WHERE user_Fname = '$user'") or die('query failed');
                        if(mysqli_num_rows($check) > 0){
                              while($fetch_product = mysqli_fetch_assoc($check)){
                              $email_id = $fetch_product['user_Email'];
                              }
                  } 

                  $check_purchase = mysqli_query($conn, "SELECT * FROM `purchase_order` WHERE user_Name = '$user'") or die('query failed');
                  if(mysqli_num_rows($check_purchase) > 0){
                        while($fetch_product = mysqli_fetch_assoc($check_purchase)){
                              $name_id = $fetch_product['user_Name'];
                              $slip = $fetch_product['pur_Slip'];
                              $order_id = $fetch_product['pur_orderID'];
                        }
                  }
                  $message .= $order_id . "<br><br>";
                  $message .= $slip;
                  $recipient = $email_id;
                  ...
                  //if (send_mail($recipient, $subject, $message)){
                        ...
                        //Delete user in cart
                        $remove_cart = mysqli_query($conn, "TRUNCATE TABLE `cart_order`") or die('query failed');
                        if ($remove_cart){
                              //insert user into database
                              $query = "UPDATE `purchase_order` SET `pur_Address` = '$address' WHERE `user_Name` = '$user'";
                              $result = mysqli_query($conn, $query);
                              if ($result)
                              {
                                    $msgv = "Item(s) purchased successfully!
                                    <script>
                                    setTimeout(()=>{
                                    window.location.replace('/connex/user/view_slips.php');
                                    },3000)
                                    </script>
                                    ";
...
<html lang="en" class="">
    ...
    <title>Connex Store - Payment</title>
...
cursor: pointer;
  ...
  clip:auto !important;
  color-scheme:light !important;}#zpas9l8p2deo1683549773161.widget-hidden {display: none !important;}#zpas9l8p2deo1683549773161.widget-visible {display: block !important;}
  @media print{
   #zpas9l8p2deo1683549773161.widget-visible { 
  display: none !important;
   }
  }</style><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script><script src="https://cdn.jsdelivr.net/emojione/2.2.7/lib/js/emojione.min.js" type="text/javascript" async="" defer=""></script><style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#s6pticm89eh1683549773221.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#s6pticm89eh1683549773221.closed{animation: tawkMaxClose .25s ease!important}</style></head>
          ...
          <div id="mobile_user_wrapper" class="rwd_menu_open hidden-md-up" style="display:none;">
                              ...
                              <div class="col-md-8">
                                    <section id="checkout-personal-information-step" class="checkout-step -current -reachable js-current-step -clickable">
                                          ...
                                          <div class="tab-content">
                                                      ...
                                                      <form action="" id="customer-form" class="js-customer-form" method="post">
                                                            <section>
                                                                  ...
                                                                  <div class="form-group row ">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <input class="form-control" name="card-name" type="text" value="<?php echo $user; ?>" required="">
                                                                        </div>
                                                                  ...
                                                                  <div class="form-group row ">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <input class="form-control" name="credit-num" type="number" value="" required="">
                                                                        </div>
                                                                        <div class="col-md-3 form-control-comment"></div>
                                                                  </div>
                                                                  <div class="form-group row ">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <input class="form-control" name="month" type="month" value="" required="">
                                                                        </div>
                                                                        <div class="col-md-3 form-control-comment"></div>
                                                                  </div>
                                                                  <div class="form-group row ">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                              <input class="form-control" name="cv-num" type="number" value="" required="">
                                                                        </div>
                                                                        <div class="col-md-3 form-control-comment"></div>
                                                                  </div>
                                                                  <p>
                                                                        <span class="font-weight-bold">Enter Address Details</span><br>
                                                                        <span class="text-muted">Please make sure it's the correct Address!</span>
                                                                  </p>
                                                                  <div class="form-group row ">
                                                                        <label class="col-md-3 form-control-label required">
                                                                              Address
                                                                  ...
                                                                  <section>
                                                                        <footer class="form-footer text-sm-center clearfix">
                                                                              <button id="submit-login" name="submit-pay" class="btn btn-primary" type="submit">
                                                                                    Pay
                                                                              </button>
                                                                        </footer>
                                                                  </section>
                                                ...
                                                <form id="login-form" action="https://connexstore.co.za/order" method="post">
                                                      <section>
                                                      ...
                                                      <div class="captcha_login form-group row required login page_order ver17">
                                                            <label for="pa_captcha" class="col-md-3">
                                                                  Security check
                                                            </label>
                                                            <div class="pa-captcha-inf col-md-6">
                                                                  <div class="g-recaptcha"><div style="width: 304px; height: 78px;">
                                                                        <div>
                                                                              <iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6Ld8u24jAAAAAGSiYNPXzZLqcpbVcS_fN8-n8U78&amp;co=aHR0cHM6Ly9jb25uZXhzdG9yZS5jby56YTo0NDM.&amp;hl=en&amp;v=1h-hbVSJRMOQsmO_2qL9cO0z&amp;theme=light&amp;size=normal&amp;cb=oh3row9tt4m" width="304" height="78" role="presentation" name="a-ak9jlw2x9e6k" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe>
                                                                        </div><textarea id="g-recaptcha-response-1" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea>
                                                                  </div><iframe style="display: none;"></iframe>
                                                            </div>                                                                                                      </div>
                                                            <div class="col-md-3 form-control-comment"></div>
                                                      </div>
                                                      <div class="forgot-password">
                                                            <a href="https://connexstore.co.za/password-recovery" rel="nofollow">
            ...
            <section id="js-checkout-summary" class="card js-cart" data-refresh-url="https://connexstore.co.za/cart?ajax=1&amp;action=refresh">
                  <div class="card-block">
                        <?php
                              $total = 0;
                              $query = mysqli_query($conn, "SELECT `pur_Totamount` FROM `purchase_order`") or die('query failed');
                              if(mysqli_num_rows($query)){
                                    $row = mysqli_fetch_assoc($query);
                                    $total = $row['pur_Totamount'];
                              }
                        ?>
                        <h4 class="show_cart"><a rel="nofollow" href="#">Shopping Cart</a></h4>
  ...
  <script type="text/javascript">
                  ...
                  $(window).on("unload", function (e) {
                      ...
                      pagetime.append("time_start", "2023-05-08 14:42:50");
                      pagetime.append("token", "f194a7383002a78a3a1687b7c252924c8d2fd6ad");
