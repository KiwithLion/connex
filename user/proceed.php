<?php
	...
	if (isset($_POST['check'])){
		...
		if ($tot_Amount > 0){
			...
			$query = "INSERT INTO `purchase_order` (user_Name, pur_Totamount, pur_Slip, pur_orderID) VALUES('$user', '$tot_Amount', '$slip_result', '$order_id')";
			$result = mysqli_query($conn, $query);
			if ($result)
			{
				$msgv = "Item(s) successfully selected!";
				header("refresh:5;checkout.php");
				
			}
			else
			{
				$msgiv = "Error while inserting values into database!";
			}
		}
		else
		{
...
cursor: pointer;
	...
	<div id="_desktop_user_info">
		<div class="user-info">
			...
			<div class="hidden-sm-down">
				...
				<a class="account" href="#" title="View my customer account" rel="nofollow"><?php echo $user; ?></a>
  ...
  <aside id="notifications">
	...
	<ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
		  ...
		  <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
			<a itemprop="item" href="https://connexstore.co.za/">
		...
		<?php 
			if(isset($_POST['delete_id'])){
				...
				if ($remove_product){
					$msg = "Product $remove_id has been removed!";
				}
				else
				{
	...
	<div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12">
			...
			<div class="card cart-container">
				...
				<div class="cart-overview js-cart" data-refresh-url="//connexstore.co.za/cart?ajax=1&amp;action=refresh">
					...
					if ($count > 0){
						?>
					<div class="msg-vaild"><?php echo $msgv; ?></div>
					<?php
					}
					?>
					<?php 
					if ($count > 0){
						?>
					<div class="msg-invaild"><?php echo $msgiv; ?></div>
					<?php
					}
					?>
					<ul class="cart-items">
					<?php
								$total = $amt = 0; $count = 1;
								$select_product = mysqli_query($conn, "SELECT * FROM `cart_order`") or die('query failed');
								if(mysqli_num_rows($select_product) > 0){
									while ($row = mysqli_fetch_assoc($select_product)) {
										...
										$img = $row['item_Image'];
										$des = $row['item_Des'];
										$product_id = $row['item_itemID'];
	
										if ($img != ""){ 
						echo "<li class='cart-item'>";				
							echo "<div class='product-line-grid'>";
								/*  product left content: image */
								echo "<div class='product-line-grid-left col-md-3 col-xs-4'>";
									echo "<span class='product-image media-middle'>";
										echo ("<img src='../images/$img' alt='$des'");
									echo "</span>";
								echo "</div>";
							/*  product left body: description */
							echo "<div class='product-line-grid-body col-md-4 col-xs-8'>";
								echo "<div class='product-line-info'>";
									echo ("<h4> $des </h4>");
								echo "</div>";
								echo "<div class='product-line-info product-price h5 has-discount'>";
									echo "<div class='product-discount'>";
										echo ("<span class='price_red'>R&nbsp;$price; </span>");
									echo "</div>";
							
											if($quantity != ""){
												$amt  += (floatval($price) * intval($quantity));
											}
											else{
												$amt += (floatval($price) * 1);
											}

											$total += $amt;
											$count += intval($quantity);
											$slip .= "$des ========= $price <br><br>";
									}
									?>
							...
							<div class="product-line-grid-right product-line-actions col-md-5 col-xs-12">
								<div class="row">
												...
												<div class="col-md-6 col-xs-6 qty">
													<div class="input-group bootstrap-touchspin">
														...
														<form action = "" method = "POST">
															<input class="js-cart-line-product-quantity form-control"  type="number" value="<?php echo $count ?>" name="product-quantity" min="1" style="display: block;">
										...
										<div class="col-md-2 col-xs-2 text-xs-right">
											<div class="cart-line-product-actions">
												<form action="" method="post">
													...
													<button class="btn add-to-cart" name="delete_id" type="submit">
									...
									<?php 
										...
										$slip .= "<br>Total R" . $total . "<br><br>=============<br>"; 
									}
									?>
								</div>
								<div class="clearfix"></div>
  ...
  <div class="estimated_delivery_date" style="display: block;">
	  <div class="estimated_delivery_date_wrapper">
		  ...
		  <div class="estimated_delivery_date_content">
			  Expected delivery date : <span class="estimated_delivery_date_value">10/06/2023</span>
		  </div>
	  </div>
  </div>
		...
		<div class="cart-grid-right col-xs-12 col-lg-4">
			...
			<div class="card cart-summary">
				...
				<div class="roja-modified-quote">
	  <div class="shopping-cart-footer-quotation-order">
		  <i class="icon-warning"></i> <span>You are not permitted to modify this cart.  If you wish to purchase your quote, please reload it form the 'My Quotes' area.</span>
		  <div class="text-sm-center">
			  <a href="https://connexstore.co.za/module/roja45quotationspro/QuotationsProFront?action=getCustomerQuotes">
				  My Quotes
			  </a>
		  </div>
	  </div>
  ...
  <div class="roja-quote-in-cart">
	  <div class="shopping-cart-footer-quotation-order">
		  <i class="icon-warning"></i> <span>Your cart contains items from your selected quotation, please complete the checkout process as normal.  Modifying this cart may invalidate the quotation.</span>
	  </div>
	  <div class="roja-clear-quote text-sm-center">
		  <a title="This will remove the quote from your cart.  You can add it again from your account area." class="btn btn-secondary btn-clear-quote" href="#">
			  Remove Quote
		  </a>
	  </div>
  </div>
  ...
  <div class="cart-detailed-totals">
	...
	<div class="card-block">
			...
			<span class="value">R&nbsp;<?php echo $total; ?></span>
					</div>
	...
	<div class="checkout cart-detailed-actions card-block">
			<div class="text-sm-center">
				<form action="" method="POST">
					...
					<button class="btn btn-primary" name = "check" type="submit">Proceed to checkout</button>
				</form>
			</div>
		</div>
	  ...
	  <div class="fb-page fb_iframe_widget" data-href="https://web.facebook.com/profile.php?id=100090032495161" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" fb-xfbml-state="rendered" fb-iframe-plugin-query="adapt_container_width=true&amp;app_id=&amp;container_width=292&amp;hide_cover=false&amp;href=https%3A%2F%2Fweb.facebook.com%2Fprofile.php%3Fid%3D100090032495161&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;width=500"><span style="vertical-align: bottom; width: 292px; height: 130px;"><iframe name="f17c91eb27b0f4" width="500px" height="1000px" data-testid="fb:page Facebook Social Plugin" title="fb:page Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="https://web.facebook.com/v2.6/plugins/page.php?adapt_container_width=true&amp;app_id=&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df1fef1e7da4e7d8%26domain%3Dconnexstore.co.za%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fconnexstore.co.za%252Ff1486b5d8c7a224%26relation%3Dparent.parent&amp;container_width=292&amp;hide_cover=false&amp;href=https%3A%2F%2Fweb.facebook.com%2Fprofile.php%3Fid%3D100090032495161&amp;locale=en_US&amp;sdk=joey&amp;show_facepile=true&amp;small_header=false&amp;width=500" style="border: none; visibility: visible; width: 292px; height: 130px;" class=""></iframe></span></div>
  </div>
	...
	<div class="container">
	  ...
	  <div class="row">
			  ...
			  <div class="col-md-3 links wrapper">
					  ...
					  <div class="title clearfix hidden-md-up" data-target="#footer_sub_menu_3731" data-toggle="collapse">
			...
			<ul id="footer_sub_menu_3731" class="collapse">
							<li>
				  ...
				  <div class="col-md-3 links wrapper">
					  ...
					  <div class="title clearfix hidden-md-up" data-target="#footer_sub_menu_4435" data-toggle="collapse">
			...
			<ul id="footer_sub_menu_4435" class="collapse">
							<li>
  ...
  <script type="text/javascript">
				  ...
				  $(window).on("unload", function (e) {
					  ...
					  pagetime.append("id_connections", "198106");
					  pagetime.append("id_page", "290");
					  pagetime.append("time_start", "2023-05-08 14:23:06");
					  pagetime.append("token", "2407b49cedc3f49aea514ab1d9f3cb3a518fd6aa");
		  ...
		  document.addEventListener('DOMContentLoaded', function() {
			  if (typeof GoogleAnalyticEnhancedECommerce !== 'undefined') {
				  ...
				  MBG.setCurrency('ZAR');
				  MBG.removeFromCart({"id":3548,"name":"rugby-challenge-4-ps4","category":"home","brand":"playstation","variant":"","type":"virtual","position":"0","quantity":1,"list":"cart","url":"https%3A%2F%2Fconnexstore.co.za%2Fhome%2F3548-rugby-challenge-4-ps4-9312590124341.html","price":1200});MBG.addToCart({"id":5039,"name":"bose-music-amplifier-speaker-amp-with-bluetooth-wi-fi-connectivity","category":"home","brand":"bose","variant":"","type":"typical","position":"0","quantity":1,"list":"cart","url":"","price":18260.869566});
			  }
		  });
