                                    ...
                                    <div id="_desktop_user_info">
                                        <div class="user-info">
                                            <ul class="user_info hidden-md-up">
                                                ...
                                                <li><a href="register.php" title="Register to your customer account" rel="nofollow">Create an account</a></li>
                                            </ul>
                                            <div class="hidden-sm-down">
                                                <span class="welcome">Welcome,</span>
                                                <a class="account" href="login.php" title="Log in to your customer account" rel="nofollow">Sign in</a>
                                                <span class="or">or</span>
                                                <a class="account" href="register.php" title="Register and get your customer account" rel="nofollow">Create an account</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="_desktop_cart">
                                    <div class="cart_top">
                                        <div class="blockcart cart-preview inactive" data-refresh-url="//connexstore.co.za/module/ps_shoppingcart/ajax">
                                            ...
                                            <div id="subcart">
												<ul class="cart_products"><!--<i class='material-icons shopping-cart'></i>-->
													<li><?php
                                                            $tot_price = 0;                                     
                                                ...
                                                <div class="cart-buttons">
                                                    <a class="btn btn-primary viewcart" href="login.php">Check Out <i class="material-icons"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="product-right">
                                                                        <div class="product-description">
                                                                            ...
                                                                            <div class="product-bottom">
                                                                                ...
                                                                                <div class="button-container">
                                                                                    <form action="" method="post">
                                                                                        <input type="hidden" name="id" value="462315"><button class="btn add-to-cart" name="add_to_cart" type="submit">
                                                                                            <i class="material-icons shopping-cart"></i>
                                                                                            Add to cart
                                                                                        </button>
                                                                                    </form>
                                                                                            ...
                                                                                            <div class="thumbnail-container">
                                                                                                <div class="product-left">
                                                                                                    <div class="product-image-container">
                                                                                                        ...
                                                                                                        <a href="#" class="thumbnail product-thumbnail">
                                                                                                            <img src="images/pioneer-cdj-350.jpg" alt="Pioneer CDJ 350 Multi..." data-full-size-image-url="https://connexstore.co.za/11814-large_default/pioneer-cdj-350-multi-player-usbcd-refurbished.jpg" width="259" height="259">
                                                                                                        </a>
                                                                                                        <a class="quick-view" href="#" data-link-action="quickview">
                                                                                                            <i class="material-icons search">&#xE8B6;</i>Quick view
                                                                                                        </a>
                                                                                                    ...
                                                                                                    <div class="product-right">
                                                                                                        <div class="product-description">
                                                                                                            ...
                                                                                                            <div class="product-bottom">
                                                                                                                ...
                                                                                                                <div class="button-container">
                                                                                                                    <form action="" method="post">
                                                                                                                        <input type="hidden" name="id" value="424426">
                                                                                                                        <button class="btn add-to-cart" name="add_to_cart" type="submit">
                                                                                                                            <i class="material-icons shopping-cart"></i>
                                                                                                                            Add to cart
                                                                                                                        </button>
